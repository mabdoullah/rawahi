...
<div class="kt-portlet">
  ...
  <!--begin::Form-->
  <form class="kt-form kt-form--label-right"  action="{{route('agent.store')}}" method="POST" enctype="multipart/form-data">
  @csrf
    <div class="kt-portlet__body">
      <div class="form-group row">
        <div class="col-lg-6 {{ $errors->has( 'name' ) ? 'has-error' : '' }}">
          <label> الاسم</label>
          <input required type="text" class="form-control "placeholder="الاسم"  name="name" value="{{ old('name')}}">
          @if( $errors->has( 'name' ) )
