                      ...
                      <div class="row align-items-center">
                          ...
                          <div class="col-md-8 col-6">
                              <nav class="site-navigation float-left">
                                  <div class="container">
                                      <ul class="site-menu js-clone-nav d-none d-lg-block">
                                          ...
                                          <li class="d-lg-none "><a class="btn v1 active" href="#">إضافة شريك
                                                  <i class="ion-plus-round"></i></a></li>
                                          <li class="d-lg-none"><a class="btn v1" href="registration-form.html"> تسجيل سفير
                                                  <i class="ion-plus-round"></i></a></li>
                                      </ul>
                                  </div>
                              </nav>
                              ...
                              <div class="add-list float-left">
                                  <a class="btn v8 active" href="#">إضافة شريك <i
                                          class="ion-plus-round"></i></a>
                                  <a class="btn v8" href="registration-form.html">  تسجيل سفير <i
                                          class="ion-plus-round"></i></a>
                              </div>
                              ...
                              <div class="row">
                                  <div class="col-md-6">
                                      <div class="form-group">
                                          ...
                                          <input required type="text" class="form-control filter-input"
                                              placeholder="الإسم التجاري للشريك">
                                      </div>
                                  </div>
                                  <div class="col-md-6">
                                      <div class="form-group">
                                          ...
                                          <div class="nice-select filter-input" tabindex="0"><span
                                                  class="current">اختر الفئات</span>
                                              <ul class="list">
                                                  <li class="option selected focus">متجر</li>
                                                  <li class="option">مطعم</li>
                                                  <li class="option">استشارات</li>
                                                  <li class="option">خدمات</li>
                                                  <li class="option">مركز تجاري</li>
                                                  <li class="option">شركة</li>
                                              </ul>
                                          </div>
                                      </div>
                                  </div>
                                  ...
                                  <div class="col-md-6">
                                      <div class="form-group">
                                          ...
                                          <input required type="text" class="form-control filter-input"
                                              placeholder="سيكون البريد الإلكتروني هو اسم المستخدم">
                                      </div>
                                  </div>
                                  <div class="col-md-12">
                                      <form>
                                  ...
                                  <div class="col-md-12">
                                      <div class="form-group">
                                          ...
                                          <div class="filter-checkbox">
                                              <input required id="check-a" type="checkbox" name="check">
