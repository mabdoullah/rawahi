...
// dd($embassadors);
            ...
            return view('admin.embassadors.index')->with('agents', $agents)->with('show_embassador',$show_embassador)->with('embassadors',$embassadors)->with('agent_id',$agent_id)->with('searchByName',$searchByName)->with('searchByEmail',$searchByEmail)->with('searchByPhone',$searchByPhone)->with('searchByAgent',$searchByAgent);
